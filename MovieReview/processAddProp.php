...
<body>
    ...
    <div id="content">
        ...
        <?php
            ...
            $propAddress=$_POST["txtpropAddress"];
            $town=$_POST["txtTownForm"];
            $county=$_POST["txtCountyForm"];
            $price=$_POST["txtPrice"];
            $status=$_POST["status"];
            $mapLink=$_POST["txtMapLink"];
            $vendor=$_POST["vendor"];
            ...
            address1, town, county, price, bedrooms,shortdescription, longdescription, image, categoryId, vendorId, status, featured, mapLink, bathrooms, size) VALUES (
            '$propAddress', '$town', '$county', $price, $bedrooms, '$shortDesc', '$longDesc', '$images', $type, $vendor, '$status', '$featured', '$mapLink', $bathrooms, $size)";

            //echo $sql_insert;

            if(mysqli_query($link, $sql_insert)) {
                $propId = $link->insert_id;
                echo "<br /><h3>Property Successfully Added</h3>";
                echo "Click <a href='admin.php'>here </a>to return to Admin page, or <a href='propertyDetails.php?id=$propId' target='_blank'>here </a>to preview the new property.";
                }
                else {
