...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-sm btn-kv btn-outline-secondaryImages',
                    removeErrorClass: 'btn btn-sm btn-kv btn-danger',
                    removeTitle: 'Remove file',
                    uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
                    uploadClass: 'btn btn-sm btn-kv btn-outline-secondaryImages',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="glyphicon glyphicon-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="glyphicon glyphicon-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-outline-secondaryImages',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="glyphicon glyphicon-zoom-in"></i>',
                    zoomClass: 'btn btn-sm btn-kv btn-outline-secondaryImages',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            ...
            toggleheader: 'btn btn-sm btn-kv btn-outline-secondaryImages',
            fullscreen: 'btn btn-sm btn-kv btn-outline-secondaryImages',
            borderless: 'btn btn-sm btn-kv btn-outline-secondaryImages',
            close: 'btn btn-sm btn-kv btn-outline-secondaryImages'
        },
        ...
        browseClass: 'btn2 btn-primary',
        removeIcon: '<i class="glyphicon glyphicon-trash"></i>',
        removeClass: 'btn2 btn-secondary',
        cancelIcon: '<i class="glyphicon glyphicon-ban-circle"></i>',
        cancelClass: 'btn2 btn-secondary',
        uploadIcon: '<i class="glyphicon glyphicon-upload"></i>',
        uploadClass: 'btn2 btn-secondary',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadExtraData: {},
