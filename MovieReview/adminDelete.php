    ...
    <script>
        ...
        $(document).ready(function () {
            $(".btnDelete").click(function () {
                var url = "http://localhost/axeproperty/processDelProp.php?propID=" + this.id;
            ...
            $(".btnUpdate").click(function () {
                ...
                var url = "http://localhost/axeproperty/adminUpdate.php?propID=" + id;
                window.location.href = url;
            });
        });
    </script>
                        ...
                        <?php
                            ...
                            if(mysqli_num_rows($result) > 0)
                            {
                                while($row=mysqli_fetch_array($result)) {
                                    ...
                                    echo "
                                    <tr>
                                        <td width='100'><img src='$images[0]' class='img-fluid' /></td>
                                        <td>$address</td>
                                        <td>$town</td>
                                        <td>$county</td>
                                        <td>€$price</td>
                                        <td>$status</td>
                                        <td><button type='submit' class='btn btn-secondary btnUpdate' id='update$propId'>Update</button></td>
                                        <td><button type='submit' class='btn btn-secondary btnDelete' id='$propId'>Delete</button></td>
                                    </tr>";
                                }
                            }
                            mysqli_close($link);
